...
class TrialExamRepository implements TrialExamService {
  ...
  @override
  Future<void> addAll({required List<TrialExam> list}) =>
  ...
  @override
  Future<List<TrialExam>?> getAll({Map<String, dynamic>? filters}) =>
  ...
  @override
  Future<void> deleteAll({required List<TrialExam> list}) =>
